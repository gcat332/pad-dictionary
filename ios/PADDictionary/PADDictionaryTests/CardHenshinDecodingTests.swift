...
final class CardHenshinDecodingTests: XCTestCase {
    func testDecodesHenshinToWhenPresent() throws {
        let json = #"{"id":5630,"name":"Test","attrs":[3],"types":[4],"rarity":7,"cost":28,"maxLevel":99,"isEmpty":false,"enabled":true,"hp":{"min":1,"max":1,"scale":1},"atk":{"min":1,"max":1,"scale":1},"rcv":{"min":1,"max":1,"scale":1},"activeSkillId":1,"leaderSkillId":1,"evoRootId":5630,"awakenings":[],"superAwakenings":[],"canAssist":false,"orbSkinOrBgmId":0,"badgeId":0,"feedExp":0,"sellPrice":0,"limitBreakIncr":0,"sellMP":0,"latentAwakeningId":0,"stackable":false,"skillBanner":false,"evoMaterials":[0,0,0,0,0],"isUltEvo":false,"evoBaseId":0,"henshinTo":[5631]}"#

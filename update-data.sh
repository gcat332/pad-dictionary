...
$DATA_ONLY || patterns+=(/images/cards_ja /images/awoken.png /images/icon-orbs.png /images/attrs.png /images/icon-type.svg /images/CARDFRAME2.png /images/CARDFRAMEW.png)
...
if ! $DATA_ONLY; then
  ...
  cp "$TMP/images/attrs.png"      images/attrs.png       # attribute crests + combo orb (36px cells, 2x7; col1 row0 = combo)
